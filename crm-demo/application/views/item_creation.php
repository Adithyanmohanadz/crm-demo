                ...
                <table class="table" id="">
                    <thead class="thead-primary bg-primary text-white">
                        <tr>
                            ...
                            <th class="text-white" scope="col">Item Name</th>
                            <th class="text-white" scope="col">Item Code</th>
                            <th class="text-white" scope="col">Tax</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $wc->item_id ?></td>
                            <td><?php echo $wc->item_name ?></td>       
                            <td><?php echo $wc->code ?></td>               
                            <td><?php echo $wc->tax ?>&nbsp;%</td>               
